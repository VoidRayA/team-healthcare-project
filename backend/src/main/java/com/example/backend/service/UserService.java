...
//    // 사용자 조회 및 생성
//    @Transactional
//    public UserDtos.SeniorResponseDto createSenior(UserDtos.SeniorCreateRequestDto dto,
...
//    }
    // 보호자 생성
    @Transactional
    public UserDtos.GuardianResponseDto createGuardian(UserDtos.GuardianCreateRequestDto dto, Integer userId, String name) {
        Guardians guardians = Guardians.builder()
                .id(dto.id())
                .loginId(dto.loginId())
        ...
        guardianRepository.save(guardians);

        return new UserDtos.GuardianResponseDto(guardians);
    }
